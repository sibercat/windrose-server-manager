...
partial class MainForm
{
    ...
    private void BuildTooltips()
    {
        ...
        toolTip.SetToolTip(txtInviteCode,
            ...
            "Generated by the server on first run — read-only.");
        ...
        toolTip.SetToolTip(numMaxPlayers,        "Maximum number of players allowed on the server at the same time.");
